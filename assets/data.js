const videos = [
    ...
    { 
        id: 'UcT1oTETbvg', 
        title: 'Capítulo 7: Modal', 
        description: 'Modal sirve para agregrar cuadros de diálogo a un sitio o mostrar notificaciones.',
        longDescription: 'Modal sirve para agregrar cuadros de diálogo a un sitios o mostrar notificaciones a los usuarios.',
        owner: 'Damaris'
    },
    { 
        id: 'koNE06AJApQ', 
        title: 'Capítulo 8: Spinners', 
        description: 'El componente Spinner de boostrap indica que un sitio web se está cargando. ',
        longDescription: 'El componente Spinner indica el estado de carga de un sitio web.',
        owner: 'Damaris'
    },
    { 
        id: 'Dkb3gvNo4o4', 
    ...
    { 
        id: 'op2g1dNdAOQ', 
        title: 'Capítulo 11:Breadcrums', 
        description: 'Los Breadcrumbs nos indica en que parte de un sitio web nos encontramos.',
        longDescription: 'Normalmente se utilizan los Breadcrums para orientar al usuario sobre en que parte del sitio se encuentra. Puedes ver la documentación oficial en <br> https://getbootstrap.com/docs/4.0/components/breadcrumb/',
        owner: 'Damaris'
    },
    { 
        id: 'NqYDAVAKAPg', 
        title: 'Capítulo 12: Pagination', 
        description: 'Se utiliza para interactuar con diversas páginas de publicaciones o multimedia',
        longDescription: 'BEl componente pagination se utiliza para interactuar con diversas páginas, publicaciones, videos o imágenes.',
        owner: 'Hernan'
    },
